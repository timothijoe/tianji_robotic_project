...
- 机器人自身左侧是世界 `+Y`。手掌参考点始终比当前刀位更靠左 160 mm，且
  沿 `-X` 靠近机器人 80 mm；录制动作再继续向左后退约 30 mm。160 mm 是掌心
  参考间隔，真实整手与刀的最小几何距离仍按 20 mm 阈值检查。
...
纯桌面修正后的真实 Headless 验收结果为 5 次切菜、5 次完整手势，桌面抬高
40 mm，计划最小刀手距离 28 mm、最大桌面穿透 0.356 mm、拇指最小离桌距离
32 mm。
